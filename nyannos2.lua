...
local Window = Fluent:CreateWindow({Title = "nyann os [Version:V2]",SubTitle = "| by real_@nyann",TabWidth = 155,Size = UDim2.fromOffset(555, 320),Acrylic = false,Theme = "Darker",MinimizeKey = Enum.KeyCode.End})
